...
Source0  : https://mirrors.kernel.org/gnu/gdbm/gdbm-1.24.tar.gz
Source1  : https://mirrors.kernel.org/gnu/gdbm/gdbm-1.24.tar.gz.sig
...
%setup -q -n gdbm-1.24
cd %{_builddir}/gdbm-1.24
pushd ..
cp -a gdbm-1.24 build32
popd
pushd ..
cp -a gdbm-1.24 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720027855
